...
#
# Generated by Vivado on Fri Aug 25 16:26:20 +0300 2023
...
set orig_proj_dir "[file normalize "$origin_dir/../work/DMA"]"
...
gpio[0]#qspi0_ss_b#qspi0_io[0]#qspi0_io[1]#qspi0_io[2]#qspi0_io[3]/HOLD_B#qspi0_sclk#gpio[7]#qspi_fbclk#reset#gpio[10]#gpio[11]#gpio[12]#gpio[13]#rx#tx#tx_clk#txd[0]#txd[1]#txd[2]#txd[3]#tx_ctl#rx_clk#rxd[0]#rxd[1]#rxd[2]#rxd[3]#rx_ctl#data[4]#dir#stp#nxt#data[0]#data[1]#data[2]#data[3]#clk#data[5]#data[6]#data[7]#clk#cmd#data[0]#data[1]#data[2]#data[3]#reset#cd#gpio[48]#gpio[49]#gpio[50]#gpio[51]#mdc#mdio} \
  ...
  regenerate_bd_layout -layout_string {
   ...
   "Default View_ScaleFactor":"0.633213",
   "Default View_TopLeft":"0,-33",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.0r6  2020-01-29 bk=1.5227 VDI=41 GEI=36 GUI=JA:10.0 non-TLS
#  -string -flagsOSRD
preplace port DDR -pg 1 -lvl 6 -x 1820 -y 310 -defaultsOSRD
preplace port FIXED_IO -pg 1 -lvl 6 -x 1820 -y 330 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 5 -x 1570 -y 360 -defaultsOSRD
...
preplace netloc processing_system7_0_FCLK_CLK0 1 0 6 20 430 370 430 690 500 1070 440 1350 470 1800
preplace netloc processing_system7_0_FCLK_RESET0_N 1 0 6 30 510 NJ 510 NJ 510 NJ 510 NJ 510 1790
preplace netloc rst_ps7_0_100M_peripheral_aresetn 1 1 3 380 440 700 260 1060
preplace netloc processing_system7_0_DDR 1 5 1 NJ 310
preplace netloc processing_system7_0_FIXED_IO 1 5 1 NJ 330
preplace netloc processing_system7_0_M_AXI_GP0 1 1 5 370 10 NJ 10 NJ 10 NJ 10 1800
preplace netloc ps7_0_axi_periph_M00_AXI 1 2 1 710 130n
preplace netloc axis_data_fifo_0_M_AXIS 1 2 1 N 350
preplace netloc axi_dma_0_M_AXIS_MM2S 1 1 3 390 250 NJ 250 1050
...
levelinfo -pg 1 0 200 540 880 1210 1570 1820
pagesize -pg 1 -db -bbox -sgen 0 0 1940 710
"
}
...
if { [get_property IS_LOCKED [ get_files -norecurse DMA_BD.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/../work/DMA/DMA.gen/sources_1/bd/DMA_BD/hdl/DMA_BD_wrapper.v" ]
} else {
